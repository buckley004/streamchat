...
const steps = [
  {
    emoji: '🎬',
    title: 'Commente tes séries en temps réel',
    desc: 'Ouvre StreamChat pendant que tu regardes et rejoins des milliers de spectateurs qui commentent au même moment.',
  },
  {
    emoji: '⏱',
    title: 'Synchronisé à la seconde près',
    desc: 'Appuie sur "Je regarde maintenant" quand tu lances ton épisode. Tes commentaires seront horodatés automatiquement.',
  },
  {
    emoji: '💬',
    title: 'Réagis, réponds, connecte-toi',
    desc: 'Like les commentaires, réponds avec @pseudo, et découvre ce que les autres pensent de chaque scène.',
  },
]
...
const s = {
  ...
  dot: { width:8, height:8, borderRadius:'50%', background:'#2C2C2A' },
