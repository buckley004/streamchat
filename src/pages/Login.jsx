...
export default function Login() {
  ...
  return (
    <div style={s.page}>
      ...
      <h1 style={s.title}>StreamChat</h1>
      <p style={s.subtitle}>Commentez vos séries et films en temps réel, au moment exact de chaque scène.</p>
      ...
      <div style={s.tagline}>
        <div style={s.feature}><div style={s.dot}/> Commentaires synchronisés à la seconde</div>
        <div style={s.feature}><div style={s.dot}/> Toutes les séries et tous les films</div>
        <div style={s.feature}><div style={s.dot}/> Communauté en temps réel</div>
      </div>
    </div>
  )
}
